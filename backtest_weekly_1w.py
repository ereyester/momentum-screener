...
def main():
    ...
    print(Fore.YELLOW + "========================================================")
    print("   Momentum Chimp Backtester (Weekly + 1W Factor) v1.0")
    print("   Weekly Rebalancing, 1W factor (40%), No Stop-Loss")
    if args.max_score:
    ...
    for i in range(start_idx, len(weeks) - 1):
        ...
        for ticker in tickers:
            ...
            try:
                ...
                # 超短期モメンタムを重視 (1W:40%, 1M:30%, 3M:20%, 6M:10%)
                raw_score = (ret_1w * 0.4) + (ret_1m * 0.3) + (ret_3m * 0.2) + (ret_6m * 0.1)
