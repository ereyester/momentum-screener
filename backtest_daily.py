...
def main():
    ...
    print(Fore.YELLOW + "========================================================")
    print("   Momentum Chimp Backtester (Daily Open-to-Open) v1.0")
    print("   Daily Rebalancing, No Stop-Loss, Past 2 Years")
    print("========================================================\n" + Style.RESET_ALL)
    ...
    # Daily Rebalancing (step=1)
    for i in range(start_idx, len(days) - 1, 1):
        trade_day = days[i]
        next_trade_day = days[i+1]
    ...
    print("\n====================================================================================================")
    print("  🐒 バックテスト月次集計 (毎日・寄り付き売買 / ロスカットなし)")
    print("====================================================================================================")
    ...
    print("\n========================================================")
    print(Fore.CYAN + "  🏆 バックテスト最終結果 (Daily Open-to-Open)" + Style.RESET_ALL)
    print("========================================================")
    ...
    if final_pf > final_bm:
        ...
        print(Fore.RED + f"  💀 チンパンはベンチマークに {underperform:+.2f}% 負けました（往復ビンタで崩壊）" + Style.RESET_ALL)
